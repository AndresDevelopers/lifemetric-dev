...
const messages = {
  es: {
    ...
    foodForm: {
      ...
      mainFoodLabel: 'Alimento principal (autocompletado por IA, editable)',
      mainFoodPlaceholder: 'Ej. Pollo con vegetales',
      notesLabel: 'Notas del plato (autocompletado por IA, editable)',
    ...
    medicationForm: {
      ...
      virusScanning: 'Escaneando imagen en VirusTotal. Si pasa, la subiremos automáticamente...',
    ...
    settings: {
      ...
      virusScanning: 'Escaneando con VirusTotal. Si el archivo es seguro, se subirá automáticamente...',
      virusPassed: 'Verificación completada. Archivo seguro, iniciando subida.',
      virusBlocked: 'Subida bloqueada.',
      virusFallback: 'VirusTotal no está disponible en este momento. Continuamos de forma resiliente.',
      fields: {
  ...
  en: {
    ...
    foodForm: {
      ...
      mainFoodLabel: 'Main food (AI auto-filled, editable)',
      mainFoodPlaceholder: 'E.g. Chicken with vegetables',
      notesLabel: 'Plate notes (AI auto-filled, editable)',
    ...
    medicationForm: {
      ...
      virusScanning: 'Scanning image with VirusTotal. If it passes, we will upload it automatically...',
    ...
    settings: {
      ...
      virusScanning: 'Scanning with VirusTotal. If safe, it will be uploaded automatically...',
      virusPassed: 'Verification completed. File is safe, starting upload.',
      virusBlocked: 'Upload blocked.',
      virusFallback: 'VirusTotal is currently unavailable. Continuing in resilient mode.',
      fields: {
