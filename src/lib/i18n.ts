...
const messages = {
  es: {
    ...
    home: {
      ...
      cardsRuntimeLabel: 'Actualizado para tus tarjetas',
    ...
    summary: {
      ...
      latestGlucoseStatusLow: 'Glucosa baja',
      latestGlucoseStatusInRange: 'Glucosa en rango',
      latestGlucoseCriticalLow: 'Actúa ahora: si estás por debajo de 70 mg/dL, corrige con carbohidrato de acción rápida y vuelve a medir en 15 minutos.',
      latestGlucoseCriticalHigh: 'Atención: mantente hidratado, evita carbohidratos de rápida absorción y verifica una nueva medición hoy.',
      latestGlucoseCriticalVeryHigh: 'Importante: una glucosa muy alta puede ser riesgosa. Si tienes malestar (náusea, vómito, somnolencia o visión borrosa), busca atención médica hoy.',
      latestGlucoseCriticalInRange: 'Vas bien: mantén este rango con tus horarios de comida, medicación y monitoreo diario.',
  ...
  en: {
    ...
    home: {
      ...
      cardsRuntimeLabel: 'Updated for your cards',
    ...
    summary: {
      ...
      latestGlucoseStatusLow: 'Low glucose',
      latestGlucoseStatusInRange: 'Glucose in range',
      latestGlucoseCriticalLow: 'Act now: if you are below 70 mg/dL, take fast-acting carbs and recheck in 15 minutes.',
      latestGlucoseCriticalHigh: 'Attention: stay hydrated, avoid fast-absorbing carbs, and check another glucose reading today.',
      latestGlucoseCriticalVeryHigh: 'Important: very high glucose can be risky. If you feel unwell (nausea, vomiting, drowsiness, or blurry vision), seek medical care today.',
      latestGlucoseCriticalInRange: 'You are doing well: keep this range with consistent meals, medication, and daily tracking.',
